...
Original file is located at
    https://colab.research.google.com/drive/18IXpcwMOYMz91hxMVhhqCobe81Ns7AEh
...
# Convertir precios a clases (1 = caro, 0 = barato)
...
- VP: casas caras bien clasificadas  
- VN: casas baratas bien clasificadas  
- FP: casas baratas clasificadas como caras  
- FN: casas caras clasificadas como baratas  

Los falsos negativos indican que el modelo no identifica correctamente casas de alto valor.

## Métricas

- Accuracy: porcentaje de aciertos totales  
- Precision: qué tan confiable es al predecir casas caras  

## Conclusión

El modelo logra distinguir entre casas caras y baratas, pero es importante reducir errores, especialmente en la clasificación de casas de alto valor.

#Conclusión

Desde mi perspectiva como estudiante de Ciencias de la Computación, este laboratorio me ayudó a entender cómo la complejidad de un modelo impacta su capacidad de generalización. Observé que aumentar el grado del polinomio no siempre mejora el desempeño, ya que puede provocar sobreajuste, mientras que técnicas como Ridge y Lasso permiten controlar este problema de manera efectiva.\\

También comprendí la importancia de seleccionar atributos relevantes, ya que no siempre usar todas las variables produce mejores resultados. Finalmente, el análisis no supervisado me permitió ver el valor de explorar los datos más allá de la predicción. En conjunto, este ejercicio reforzó mi comprensión práctica de conceptos clave en aprendizaje automático.
